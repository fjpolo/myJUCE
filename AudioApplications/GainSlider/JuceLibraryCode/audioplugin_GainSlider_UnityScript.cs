...
public class audioplugin_GainSliderGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_GainSlider"; } }
    public override string Description    { get { return "GainSlider"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
    [DllImport("audioplugin_GainSlider")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_GainSlider")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_GainSlider")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_GainSlider")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_GainSlider")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_GainSlider")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_GainSlider")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
